...
namespace MethodTesting
{
    ...
    public class Methods
    {
        ...
        public void TestIterativeEven()
        {
            ...
            for (int i = 0; i < input.Length; i++)
            {
                actual[i] = SkalProj_Datastrukturer_Minne.Program.IterativeEven(input[i]);
            }
        ...
        public void TestIterativeFibonacci()
        {
            ...
            for (int i = 0; i < input.Length; i++)
            {
                actual[i] = SkalProj_Datastrukturer_Minne.Program.IterativeFibonacci(input[i]);
            }
